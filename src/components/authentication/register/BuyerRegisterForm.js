    ...
    const formik = useFormik({
        ...
        onSubmit: () => {
            ...
            const data = {
                ...
                shippingAddress: {
                    streetAddress: formik.values.streetAddressShipping,
                    address2: formik.values.address2Shipping,
            ...
            <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
                <Stack spacing={3}>
                    ...
                    <TextField
                        ...
                        error={Boolean(touched.streetAddressShipping && errors.streetAddressShipping)}
                        helperText={touched.streetAddressShipping && errors.streetAddressShipping}
                    />
                    <TextField
                        fullWidth
                        label="Street Address 2"
